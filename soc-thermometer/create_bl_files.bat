...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY="D:\Simplicity\developer\toolchains\gnu_arm\7.2_2017q4\bin\arm-none-eabi-objcopy.exe"
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER="D:\Simplicity\developer\adapter_packs\commander\commander.exe"
) else (
